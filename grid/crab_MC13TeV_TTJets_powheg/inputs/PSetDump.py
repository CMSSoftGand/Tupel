...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISpring16MiniAODv1/TT_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_v3_ext3-v1/00000/00485A9E-D51A-E611-8B05-0CC47A78A340.root')
)
...
process.pseudoTop = cms.EDProducer("PseudoTopProducer",
    ...
    maxVetoLeptonEtaSemilepton = cms.double(2.4),
    minDileptonMassDilepton = cms.double(0.0),
    minJetPt = cms.double(20),
    minLeptonPt = cms.double(20),
    minLeptonPtDilepton = cms.double(20),
    minLeptonPtSemilepton = cms.double(20),
    minMETSemiLepton = cms.double(0.0),
    minMtWSemiLepton = cms.double(0.0),
    minVetoLeptonPtSemilepton = cms.double(15.0),
