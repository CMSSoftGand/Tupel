...
NeutrinoSolver::NeutrinoSolver(TLorentzVector const *lep, TLorentzVector const *bjet,
  double MW, double MT):
    ERROR(false),
...
TLorentzVector NeutrinoSolver::GetBest(double metx, double mety, double metxerr, double metyerr,
...
bool NeutrinoSolver::IsReconstructable() const
{
    return not ERROR;
}
