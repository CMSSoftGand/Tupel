...
if runOnData:
	process.GlobalTag = GlobalTag(process.GlobalTag, '80X_dataRun2_Prompt_v8') #for 25 ns data
else: 
	process.GlobalTag = GlobalTag(process.GlobalTag, '80X_mcRun2_asymptotic_2016_v3') #for 25ns mc
