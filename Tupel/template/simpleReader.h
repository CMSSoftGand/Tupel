...
//TTBarSolver ttsolver;
   ...
   vector<double>  *METUncPtUp;
   vector<double>  *METUncPtDn;
   vector<double>  *METUncPhiUp;
   vector<double>  *METUncPhiDn;
   ...
   TBranch        *b_METUncPtUp;   //!
   TBranch        *b_METUncPtDn;   //!
   TBranch        *b_METUncPhiUp;   //!
   TBranch        *b_METUncPhiDn;   //!
   TBranch        *b_METRawPt;   //!
   TBranch        *b_METPt;   //!
   TBranch        *b_METPx;   //!
   TBranch        *b_METPy;   //!
  ...
  void branchAdd(TTree *tree){
   ...
   tree->SetBranchAddress("METUncPtUp", &METUncPtUp, &b_METUncPtUp);
   tree->SetBranchAddress("METUncPtDn", &METUncPtDn, &b_METUncPtDn);
   tree->SetBranchAddress("METUncPhiUp", &METUncPhiUp, &b_METUncPhiUp);
   tree->SetBranchAddress("METUncPhiDn", &METUncPhiDn, &b_METUncPhiDn);
...
std::vector<float> getJetResolutionScales(float pt, float eta, float genjpt)
{
    std::vector<float> res(3,1.0);
      ...
      else if(TMath::Abs(eta)>= 0.5 && TMath::Abs(eta)<0.8 )  { ptSF=1.138; ptSF_err = 0.013 ; }
      else if(TMath::Abs(eta)>= 0.8 && TMath::Abs(eta)<1.1 )  { ptSF=1.114; ptSF_err = 0.013; }
      else if(TMath::Abs(eta)>= 1.1 && TMath::Abs(eta)<1.3 )  { ptSF=1.123; ptSF_err = 0.024 ; }
      else if(TMath::Abs(eta)>= 1.3 && TMath::Abs(eta)<1.7)  { ptSF=1.084; ptSF_err = 0.011 ; }
      else if(TMath::Abs(eta)>= 1.7 && TMath::Abs(eta)<1.9)  { ptSF=1.082; ptSF_err = 0.035 ; }
      else if(TMath::Abs(eta)>= 1.9 && TMath::Abs(eta)<2.1)  { ptSF=1.140; ptSF_err = 0.047 ; }
      else if(TMath::Abs(eta)>= 2.1 && TMath::Abs(eta)<2.3)  { ptSF=1.067; ptSF_err = 0.053 ; }
      else if(TMath::Abs(eta)>= 2.3 && TMath::Abs(eta)<2.5)  { ptSF=1.177; ptSF_err = 0.041 ; }
      else if(TMath::Abs(eta)>= 2.5 && TMath::Abs(eta)<2.8)  { ptSF=1.364; ptSF_err = 0.039 ; }
      else if(TMath::Abs(eta)>= 2.8 && TMath::Abs(eta)<3.0)  { ptSF=1.857; ptSF_err = 0.071 ; }
      else if(TMath::Abs(eta)>= 3.0 && TMath::Abs(eta)<3.2)  { ptSF=1.328; ptSF_err = 0.022 ; }
      else if(TMath::Abs(eta)>= 3.2 && TMath::Abs(eta)<5.0)  { ptSF=1.160; ptSF_err = 0.029 ; }
